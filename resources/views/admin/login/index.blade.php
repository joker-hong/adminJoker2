...
<div class="m-login-bg">
    <div class="m-login">
        ...
        <div class="m-login-warp">
            <form class="layui-form" method="post" action="{{route('submit')}}">
                {{csrf_field()}}
                <div class="layui-form-item">
                    <input type="text" name="username" required lay-verify="required" placeholder="用户账号" autocomplete="off" class="layui-input">
                </div>
                <div class="layui-form-item">
        ...
        <p class="copyright">Copyright 2019 by {{config('app.name')}}</p>
    </div>
</div>
